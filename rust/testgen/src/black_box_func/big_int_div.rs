...
fn generate_big_int_div_test(path: &str) {
    let file_name = format!("{}/big_int_div_test.bin", path);
    ...
    let big_int_div_function_call = BlackBoxFuncCall::<FieldElement>::BigIntDiv {
        lhs: 1234,
        rhs: 5678,
        output: 91011,
    };
