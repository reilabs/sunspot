...
fn generate_indirect_const_test(path: &str) {
    ...
    let const_opcode = Opcode::<FieldElement>::IndirectConst {
        destination_pointer: MemoryAddress::Direct(1234),
...
pub fn generate_tests(directory: &str) {
    ...
    generate_indirect_const_test(&directory);

    trace!("Indirect const tests generated in {}", directory);
}
